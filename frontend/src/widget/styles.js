...
.query-composer-wrap {
  max-width: var(--content-max-width);
  margin: 0 auto;
  padding: clamp(8px, 2vw, 12px) clamp(12px, 3vw, 22px) clamp(8px, 2vw, 10px);
}
